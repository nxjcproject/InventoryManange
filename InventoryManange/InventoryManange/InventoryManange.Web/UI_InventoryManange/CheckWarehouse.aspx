...
<body>
    <div id="cc" class="easyui-layout"data-options="fit:true,border:false" >    
         <div data-options="region:'west',spilt:true" style="width: 150px;">
          ...
          <div id="toorBar" title="" style="display: none;">
                <table>
                    ...
                    <tr>
                        <td>
                            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="addFun()">盘库</a>
                        </td>
                    </tr>
                </table>         
	    </div> 
        ...
        <div id="AddandEditor" class="easyui-window" title="盘库" data-options="modal:true,closed:true,iconCls:'icon-edit',minimizable:false,maximizable:false,collapsible:false,resizable:false" style="width:600px;height:400px;padding:10px 60px 20px 60px"> 
