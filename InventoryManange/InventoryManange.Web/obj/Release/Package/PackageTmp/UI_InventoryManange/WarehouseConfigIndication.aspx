   ...
   <div id="cc" class="easyui-layout"data-options="fit:true,border:false" >    
    ...
    <div>
         <table>
                    <tr>
                        <td>组织机构:</td>
<%--                        <td><input id="productLineName" class="easyui-textbox" style="width: 80px;" readonly="readonly" /></td>   editable="false"--%>
                        <td >                               
                            <input id="organizationname" class="easyui-textbox" readonly="readonly"style="width:100px" />（*必选） </td>              
                ...
                <table>
                    <tr>
                        ...
                        <td>仓库名:</td> 
                        <td ><input id="warehousename" class="easyui-combobox"  style="width:100px" />（*选填） </td>                
                       ...
                       <td>
                        ...
                        <td>
                            <a id="deleate" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="deleteFun()">删除</a>
                        </td>
                        <td>
...
<%--                    <tr>
                  ...
                  <tr>
	    			    <td>仓库名：</td>
	    			    <td>
                          <input class="easyui-combobox" id="name"  style="width:160px" data-options="panelHeight: 'auto'"/>           
	    			    </td>
	    		  </tr>
