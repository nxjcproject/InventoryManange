...
namespace InventoryManange.Web.UI_InventoryManange
{
    public partial class WarehouseConfigIndication : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        [WebMethod]
        public static int AddContent( string mWarehousingtype, string mWarehousename, string mVariableid, string mSpecies, string mDatabasename, string mDatatablename, string mMultiple, string mOffset, string mRemark) 
        {
            int result = WarehouseConfigService.InsertWarehousing( mWarehousingtype, mWarehousename, mVariableid, mSpecies, mDatabasename, mDatatablename, mMultiple, mOffset, mUserId, mRemark);
            return result;
        }

        [WebMethod]
        public static int EditContent(string mWarehousingtype, string mWarehousename, string mVariableid, string mSpecies, string mDatabasename, string mDatatablename, string mMultiple, string mOffset, string mRemark, string mItemId) 
        {
            int result = WarehouseConfigService.EditWarehousing(mWarehousingtype, mWarehousename, mVariableid, mSpecies, mDatabasename, mDatatablename, mMultiple, mOffset, mUserId, mRemark, mItemId);
            return result;
        }
        [WebMethod]
