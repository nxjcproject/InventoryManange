...
namespace InventoryManange.Web.UI_InventoryManange
{
    public partial class CheckWarehouse : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        //}
        [WebMethod]
        public static string GetInventoryTime(string mOrganizationID, string beginTime, string endTime)
        {
            DataTable table = CheckWarehouseService.GetInventoryTimeTable(mOrganizationID, beginTime, endTime);
            string json = EasyUIJsonParser.DataGridJsonParser.DataTableToJson(table);
            return json;
        }
        [WebMethod]
        public static string GetInventoryAll(string mOrganizationID, string mtimeStamp)
        {
            DataTable table = CheckWarehouseService.InventoryWarehouseDataTableAll(mOrganizationID, mtimeStamp);
            string json = EasyUIJsonParser.TreeGridJsonParser.DataTableToJsonByLevelCode(table, "LevelCode");
            return json;
        }
        [WebMethod]
        ...
        [WebMethod]
        public static int JudgeTodayStamp(string mOrganizationID, string mStampTime)
        {
            int result = CheckWarehouseService.JudgeTodayWhetherStamp(mOrganizationID, mStampTime);
            return result;
        }
        [WebMethod]
